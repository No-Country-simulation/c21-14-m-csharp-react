...
export const Navbar = ({
  ...
  return (
    <>
      <nav class=" position-fixed navbar navbar-expand-lg  z-1 navbar-light c_navbar">
        ...
        <div
          class="collapse navbar-collapse  d-flex justify-content-end mx-5"
          id="navbarNav"
        >
          {home == "home" ? (
            ...
            <ul className="navbar-nav mb-2 col-2 mb-lg-2">
              <li class="nav-item">
                <Link
