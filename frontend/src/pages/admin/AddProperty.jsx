...
const AddProperty = () => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      const response = await fetch('https://brickly-backend.onrender.com/api/v1/properties', {
        method: 'POST',
        headers: {
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 py-3 ">
              ...
              >
                ...
                <option value="República Dominicana">Rca. Dominicana</option>
            ...
            {success && (
              <div className="border-2 border-green-500 text-green-500 my-3 rounded-md px-2 py-2">
