      ...
      <nav className="bg-slate-200  w-full shadow-xl shadow-slate-300 rounded-br-[50px] flex items-center justify-between px-20 py-3">
        <a className="navbar-brand" href="/">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#0368FE" />
                <stop offset="1" stopColor="#023E98" />
              </linearGradient>
              <linearGradient
                id="paint1_linear_410_153"
                x1="75.1345"
                y1="28.909"
                x2="143.865"
                y2="56.8899"
                gradientUnits="userSpaceOnUse"
              >
                <stop offset="0.535" stopColor="#0368FE" />
                <stop offset="1" stopColor="#3CD36D" />
              </linearGradient>
            </defs>
          </svg>
        </a>
        ...
        {home && (
          <ul className="flex w-3/4 gap-5 font-bold items-center">
            ...
            <li className="">
              <Link
                className="hover:bg-black hover:text-white px-3 rounded-md py-2 transition-colors duration-200"
                to="/Login"
              >
                Ingresar
              </Link>
